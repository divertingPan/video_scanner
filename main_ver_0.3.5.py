...
class VideoCaptureThread(threading.Thread):
    def __init__(self, video_file, stable=0):
        ...
        self.stab = Stabilizer(border_type='reflect_101', stream=self.vc)
        self.stable = stable
        ...
        while self.is_running:
            try:
                ...
                if self.stable:
                    ...
                    frame_1 = self.stab.stabilize(frame_1)
                    frame_2 = self.stab.stabilize(frame_2)
...
class Application(tk.Frame):
    ...
    def right_panel(self):
        ...
        self.frame_right_stable = tk.Frame(frame_right)
        self.frame_right_stable.pack()
    ...
    def video_stable_control(self):
        self.if_stable = tk.IntVar()

        frame_stable = tk.Frame(self.frame_right_stable)
        frame_stable.pack(side=tk.LEFT, expand=tk.YES)

        radio_manual_control = tk.Checkbutton(frame_stable, text="video stablizer", variable=self.if_stable,
    ...
    def update_frame(self, frame_num):
        ...
        self.show_on_canvas(self.VCT.current_frame_queue.get(timeout=10))
    ...
    def open_video(self):
        ...
        try:
            ...
            pass
        self.VCT = VideoCaptureThread(self.video_path.get(), self.if_stable.get())
        self.VCT.start()
        self.update_frame(0)
    ...
    def calculate_split_wp(self):
        ...
        # initiate stabilizer object with defined parameters
        stab = Stabilizer(border_type='reflect_101', stream=cv2.VideoCapture(self.video_path.get()))
        ...
        try:
            for i in range(adaptive_sensitivity):
                ...
                if self.if_stable.get():
                    # send current frame to stabilizer for processing
                    frame_1 = stab.stabilize(frame_1)
                    frame_2 = stab.stabilize(frame_2)
                    frame_3 = stab.stabilize(frame_3)
